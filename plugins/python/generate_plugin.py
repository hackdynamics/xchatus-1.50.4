...
with open(sys.argv[1]) as f:
    output = []
    eat_until_endif = 0
    # This is very specific to xchatus-plugin.h, it is not a cpp
    for line in f:
        if line.startswith('#define'):
            ...
            eat_until_endif -= 1
        elif eat_until_endif and '_xchatus_context' not in line:
            continue
        else:
            output.append(line)
...
extern "Python" int _on_print_attrs_hook(char **, xchatus_event_attrs *, void *);
extern "Python" int _on_server_hook(char **, char **, void *);
extern "Python" int _on_server_attrs_hook(char **, char **, xchatus_event_attrs *, void *);
...
builder.set_source('_xchatus_embedded', '''
