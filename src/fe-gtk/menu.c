...
{
	fe_open_url ("http://xchatus.readthedocs.org");
}
...
menu_about (GtkWidget *wid, gpointer sess)
{
	...
	gtk_about_dialog_set_website (dialog, "http://xchatus.github.io");
	gtk_about_dialog_set_website_label (dialog, "Website");
	gtk_about_dialog_set_logo (dialog, pix_xchatus);
...
static struct mymenu mymenu[] = {
	{N_("XCHATUS"), 0, 0, M_NEWMENU, MENU_ID_HEXCHAT, 0, 1},
...
#ifdef HAVE_GTK_MAC
		/* We want XCHATUS to be the app menu, not including Quit or XCHATUS itself */
