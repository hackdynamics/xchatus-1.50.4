...
#define DBUS_SERVICE "org.xchatus.service"
#define DBUS_REMOTE "/org/xchatus/Remote"
#define DBUS_REMOTE_CONNECTION_INTERFACE "org.xchatus.connection"
#define DBUS_REMOTE_PLUGIN_INTERFACE "org.xchatus.plugin"
		 ...
		 gpointer user_data)
{
	...
	if (hook_id == command_id) {
		...
		/* Now if you write "/test blah" again in the XCHATUS window
...
main (int argc, char **argv)
{
	...
	/* Now you can write on the XCHATUS windows: "/test arg1 arg2 ..." */
